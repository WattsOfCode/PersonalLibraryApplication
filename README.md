...
Book Nook is a private comprehensive mobile cataloging application designed for avid readers to manage their 
...
- Building collections
  ...
  - Smart Search – Find books manually by typing in a Title or Author (NEW!!! or by Shelf name).
  - Auto-Fill Details – Automatically fetches cover art, page counts, and book descriptions so you don't have to type them.
- Tracking your reading
  - Reading progress - you can log your last read page to pick back up later using the Note feature!
  - Reading History - marking system allows you to lable books as "To-Read, Currently reading or finished"
- Managing your library
  - Loan Tracker - Icon after trigger to identify if your book is currently being loaned out.
...
- Privacy & Security
  - Login user & pw - Create a username and password teing them to your personal library
